...
public class CommonConstants {
	...
	/** 有効;無効 */
	public static final String COMB_kaihaiYN 		= "kaihaiYN";

	/** 請求;許可;不許可 */
	public static final String COMB_KO001 		= "sibko";
	
	/** 請求;取消;許可;不許可;PJL許可;経理担当者許可;経理担当者不許可;すべて */
	public static final String COMB_KOR001 		= "sibkoR001";
	
	/** 請求;PJL許可;PJL不許可;経理担当者許可;経理担当者不許可;すべて */
	public static final String COMB_KOL001 		= "sibkoL001";
	
	/** 請求;取消 */
	public static final String COMB_KOR003 		= "sibkoR003";
	
	/** PJL許可;経理担当者許可;経理担当者不許可;すべて */
	public static final String COMB_KOA001 		= "sibkoA001";

	/** 許可;不許可 */
	public static final String COMB_KOA002 		= "sibkoA002";
	
	/** 未払い;支払い済み;未払い/支払済み */
	public static final String COMB_KOA003 		= "sibkoA003";
	
	/** 未払い;支払済み */
	public static final String COMB_KOA004 		= "sibkoA004";
	 ...
	 * ステータスリスト用コード値
	 **************************************************/
	/** 申請、取消、PJL許可、PJL不許可、経理許可、経理不許可　*/
	public static final String STATUS_KO001 		= "sibko001";
	...
	/** 社員一覧情報 */
	public static final String SERVICE_TYPE_EMPLOYEELIST	= "employeeList";

	/** プロジェクト一覧情報 */
	public static final String SERVICE_TYPE_PJ_LIST	= "projectCodeList";

	/** プロジェクト情報 */
	public static final String SERVICE_TYPE_PJ_INFO	= "projectCode";
	
	/** 社員一覧２情報 */
	public static final String SERVICE_TYPE_EMPELIST	= "empList";

	/** ステータスリスト情報 */
	public static final String SERVICE_TYPE_STATUSLIST	= "statusList";
