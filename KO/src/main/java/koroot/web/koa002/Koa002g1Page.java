...
import koroot.web.koa001.Koa001g2Page;
import koroot.web.koa001.Koa001g3Page;
import koroot.web.kos001.Kos001g1Page;

public class Koa002g1Page extends PageBaceClass {
	...
	public Class<?> doSrech() {
		...
		keihiItems = listFormat(kogDao.getKogPayList(fromDate, toDate, inStatus, inPJCode));
	...
	public Class<?> initialize() {
		...
		try{
			...
			//検索条件-ステータスコンボ
			statusItems = this.getCombList(CommonConstants.COMB_KOA003);
