...
import koroot.validator.UserAuthValidator;
...
//		MAdapter ety_Adp = adpDao.selectById(CommonConstants.SERVICE_TYPE_USERINFO);
		...
		try {
				...
				this.sessionDto.KogutiKanriFlg = CommonConstants.STR_TRUE.equals(resParam.get("kogutiKanriFlg"));
				this.sessionDto.PjLeaderFlg = CommonConstants.STR_TRUE.equals(resParam.get("pjLeaderFlg"));
