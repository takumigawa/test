...
public class CommonConstants {
	...
	/** 送信区分　*/
	public static final String COMB_updsendtype = "updsendflg";
	...
	/** 汎用コンボリスト取得 */
	public static final String SERVICE_TYPE_GET_ALL_COMBLIST	= "getallcombList";

	/** 汎用コンボリスト更新 */
	public static final String SERVICE_TYPE_UPDATE_COMBLIST	= "updatecombList";
