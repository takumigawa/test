...
/**
 * <p>スケジュール詳細画面ページクラス</p>
 * 
 * @author J.Hira
 * @version 1.0
 *
 */
public class ScheduleViewPage {
	...
	public Class<?> prerender() {
		...
		try {
			...
			// スケジュール情報の取得
			TSchedule ety_sch = schDao.selectById(workID);
			
			// 起案者の社員情報を取得
			MEmployee ety_emp = empDao.selectById(ety_sch.employeeId);
	 ...
	 * <p>削除ボタン押下時処理</p>
	 * 
	 * @return　スケジュール削除確認画面に遷移
	 */
	public Class<?> doDelete() {
		
		return ScheduleConfPage.class;
	}
